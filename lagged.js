...
! function() {
    ...
    LaggedAPI.init = function(skipPreloadAd) {
        if (hasBeenInit) {
            return;
        }
        hasBeenInit = true;
        ...
        if (isOnApprovedWebsite) {
            ...
            try {
                ...
                try {
                    if (isOnLagged) {
                        if (window.parent.customChannelUse) {
                            element.setAttribute('data-ad-channel', window.parent.customChannelUse);
                        } else {
                            element.setAttribute('data-ad-channel', '3947082707');
                        }
                    } else if (useParentChannel) {
                        element.setAttribute('data-ad-channel', parentChanneltoUse);
    ...
    var tryPreloader = function() {
        ...
        console.log("ads loaded, skip preroll");
        if (!isDevMode) {
            disableButtons();
            try {
                adBreak({
    ...
    LaggedAPI.Achievements = {
        save: function(e, t) {
            for (var a = 0, n = e.length; a < n; a++) - 1 === vL.indexOf(e[a]) && (vL.push(e[a]), b.push(e[a]));
            var r, d;
    ...
    var E, f = function(e, t) {
            ...
            e && !0 === e.success ? !0 === e.data.show && N(e.data.achdata, e.user) : (alert("Error: Achievement did not save!"), console.log(e), a.success = !1, a.errormsg = "Error: Achievement did not save!"), t && t(a)
        },
        C = function(e, t) {
            var a = {
                success: !0
            ...
            e && !0 === e.success ? (hsData = e, function() {
                ...
                r.onclick = function() {
                    Q.getElementById("leaderboard-wrapper") && Q.getElementById("leaderboard-wrapper").remove(), Q.getElementById("leaderboard-modal") && (Q.getElementById("leaderboard-modal").onclick = "", Q.getElementById("leaderboard-modal").remove()), !1
                ...
                for (hsData.data.login || (A = 5, N.className = "moregames_wrapper"), i = 0; i < A; i++) {
                    ...
                    I.setAttribute("src", "https://imgs2.dab3games.com/" + w[i].thumb), I.setAttribute("alt", w[i].name), I.setAttribute("width", "200"), I.setAttribute("height", "200"), k.appendChild(B), k.appendChild(I), T.appendChild(k), N.appendChild(T)
                }
                f.appendChild(N), e.appendChild(f), Q.body.appendChild(e), S();
        ...
        N = function(e, t) {
            ...
            if (s.appendChild(c), n.appendChild(s), Q.body.appendChild(n), t) try {
    ...
    function adBreakIsDone() {
        ...
        // try{
        //     console.log("send ad conversion");
        //     window.parent.gtag('event', 'conversion', {'send_to': 'AW-1055364430/XhxXCIeIx_wBEM6qnvcD'});
        // }catch(e){
        //   console.log(e);
        // }
    }
            ...
            window.addEventListener("message", function(event) {
                try {
                    ...
                    if (messageType === "parentCustomChannel") {
                        ...
                        //
                        //to do v3/api.js, attach to variable
                        //
